...
export function useProfile(currentUser: any, isAuthenticated: boolean) {
...
export function useConversationSync(
  ...
  setQnaMessages: React.Dispatch<React.SetStateAction<ChatMessage[]>>,
  qnaInput: string,
  setQnaInput: (input: string) => void,
  qnaState: QnaState,
  setQnaState: (state: QnaState) => void,
  qnaAbortRef: React.MutableRefObject<AbortController | null>,
  qnaRequestVersionRef: React.MutableRefObject<number>,
  conversationIdRef: React.MutableRefObject<string>,
  qnaMessagesRef: React.MutableRefObject<ChatMessage[]>,
  qnaInputRef: React.MutableRefObject<string>,
  qnaStateRef: React.MutableRefObject<QnaState>,
  qnaDraftsRef: React.MutableRefObject<QnaDrafts>,
  qnaConversationCacheRef: React.MutableRefObject<PersistedQnaConversationCache>,
  ...
  }, [persistQnaConversationCache, qnaConversationCacheRef]);
  ...
  }, [cacheConversationView, clearPersistedQnaSnapshot, conversationIdRef, qnaAbortRef, qnaDraftsRef, qnaInputRef, qnaMessagesRef, qnaRequestVersionRef, setConversationId, setQnaInput, setQnaMessages, setQnaState]);
  ...
  const syncConversationHistory = useCallback(async ({
    ...
    return Boolean(latestMessages?.length);
  }, [cacheConversationView, conversationIdRef, mountedRef, qnaInputRef, qnaRequestVersionRef, setQnaMessages]);
  ...
  }, [cacheConversationView, conversationIdRef, qnaAbortRef, qnaConversationCacheRef, qnaDraftsRef, qnaInputRef, qnaMessagesRef, qnaRequestVersionRef, setConversationId, setQnaInput, setQnaMessages, setQnaState, syncConversationHistory]);
  ...
  }, [cacheConversationView, clearPersistedQnaSnapshot, mode, setConversationId, setQnaInput, setQnaMessages, setQnaState, syncConversationHistory]);
  ...
  }, [conversationIdRef, mode, qnaInputRef, qnaMessagesRef, qnaStateRef, syncConversationHistory]);
...
export function useQnaChat(
  ...
  openAuthModal: (type: string, message: string) => void,
  loadCurrentProfile: (source: ProfileUpdateSource) => Promise<void>,
  conversationId: string,
  setConversationId: (id: string) => void,
  qnaMessages: ChatMessage[],
  setQnaMessages: React.Dispatch<React.SetStateAction<ChatMessage[]>>,
...
export function useEngineTasks(
  ...
  setConversationId: (id: string) => void,
  conversationIdRef: React.MutableRefObject<string>,
  engineSubmitVersionRef: React.MutableRefObject<number>,
  mountedRef: React.MutableRefObject<boolean>
) {
  ...
  }, [clearPersistedEngineSnapshot, engineSubmitVersionRef, setConversationId]);
  ...
  const monitorTask = useCallback(
    ...
    [loadCurrentProfile, mountedRef, openAuthModal, updateServiceSnapshot],
  );
